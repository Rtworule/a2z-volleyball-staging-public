...
- Switch into admin mode to review active reservation payment status.
- Summarize paid and due reservations and toggle each reservation between paid and due.
